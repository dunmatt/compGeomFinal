...
(function() {
  var addEdge, addEdgeMode, click, deleteMode, deleteModeClass, deleteVertex, drag, dragended, dragmove, dragstarted, drawEdges, drawSlabs, drawVertices, edgeModeClass, edges, editModeClass, height, keyAlreadyDown, keydown, keyup, lines, points, radius, reset, slabLines, svg, tentativeEdge, vertices,
  ...
  d3.select("body").append("button").text("Toggle Query Mode").on("click", function() {
    return svg.classed(editModeClass, !svg.classed(editModeClass));
  });
