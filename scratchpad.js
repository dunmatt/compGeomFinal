...
(function() {
  var addEdge, addEdgeMode, click, deleteMode, deleteVertex, drag, dragended, dragmove, dragstarted, drawEdges, drawSlabs, drawVertices, edges, height, keyAlreadyDown, keydown, keyup, lines, points, radius, reset, slabLines, svg, tentativeEdge, vertices,
  ...
  svg = d3.select("body").append("svg").attr("width", 700).attr("height", height).attr("class", "editMode");
