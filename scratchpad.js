...
(function() {
  var addEdge, addEdgeMode, click, deleteMode, deleteModeClass, deleteVertex, drag, dragended, dragmove, dragstarted, drawEdges, drawSlabs, drawVertices, edgeModeClass, edges, editMode, editModeClass, height, keyAlreadyDown, keydown, keyup, lines, points, radius, reset, slabLines, svg, tentativeEdge, toggleEditMode, vertices,
  ...
  toggleEditMode = function() {
    ...
    return svg.classed(editModeClass, editMode);
  };
